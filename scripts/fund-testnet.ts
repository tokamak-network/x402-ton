...
const L1_USDC = "0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238" as const;
const L2_USDC = "0x4200000000000000000000000000000000000778" as const;
const L1_USDC_BRIDGE = "0x7dD2196722FBe83197820BF30e1c152e4FBa0a6A" as const;
...
async function pollL2Balance(
  l2Public: ReturnType<typeof createPublicClient>,
  address: `0x${string}`,
